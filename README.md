...
![CI](https://github.com/erboladaiorg/eligendi-reiciendis-id/workflows/CI/badge.svg)
[![NPM version](https://img.shields.io/npm/v/@erboladaiorg/eligendi-reiciendis-id.svg?style=flat)](https://www.npmjs.com/package/@erboladaiorg/eligendi-reiciendis-id)
...
const inject = require('@erboladaiorg/eligendi-reiciendis-id')
...
```typescript
import * as LightMyRequest from '@erboladaiorg/eligendi-reiciendis-id'
...
// or
import { inject, DispatchFunc } from '@erboladaiorg/eligendi-reiciendis-id'
...
- `inject` - standard @erboladaiorg/eligendi-reiciendis-id `inject` method
- `DispatchFunc` - the fake HTTP dispatch function
- `InjectPayload` - a union type for valid payload types
- `isInjection` - standard @erboladaiorg/eligendi-reiciendis-id `isInjection` method
- `InjectOptions` - options object for `inject` method
- `Request` - custom @erboladaiorg/eligendi-reiciendis-id `request` object interface. Extends
...
- `Response` - custom @erboladaiorg/eligendi-reiciendis-id `response` object interface. Extends Node.js `http.ServerResponse` type
...
- Beware when using the `Request` option. That might make _@erboladaiorg/eligendi-reiciendis-id_
...
Checks if given object `obj` is a *@erboladaiorg/eligendi-reiciendis-id* `Request` object.
...
All the credits before the commit [00a2a82](https://github.com/erboladaiorg/eligendi-reiciendis-id/commit/00a2a82eb773b765003b6085788cc3564cd08326) goes to the `hapi/shot` project [contributors](https://github.com/hapijs/shot/graphs/contributors).
Since the commit [db8bced](https://github.com/erboladaiorg/eligendi-reiciendis-id/commit/db8bced10b4367731688c8738621d42f39680efc) the project will be maintained by the Fastify team.
